...
// APP - RIGHT MENU
.controller('AppCtrl', function($scope, $rootScope, AuthService) {
  $rootScope.url = 'http://192.168.0.2/wp-json/wp/v2/';
...
// CATEGORY
.controller('WorkOrderCtrl', function($scope, $rootScope, $state, $ionicLoading, $stateParams, PostService) {
...
.controller('ChecklistCtrl', function($scope, $stateParams, DataLoader, $ionicLoading, $rootScope, $sce, CacheFactory, $log, Bookmark, $timeout ) {
  ...
  var singlePostApi = $rootScope.url + 'checklists/' + $scope.itemID;
...
.controller('ChecklistsCtrl', function( $scope, $http, DataLoader, $timeout, $ionicSlideBoxDelegate, $rootScope, $log ) {

  var postsApi = $rootScope.url + 'checklists/';
...
.controller('ScheduleDetailCtrl', function($scope, $stateParams, DataLoader, $ionicLoading, $rootScope, $sce, CacheFactory, $log, Bookmark, $timeout ) {
  ...
  var singlePostApi = $rootScope.url + 'schedule/' + $scope.itemID;
...
.controller('ScheduleListCtrl', function( $scope, $http, DataLoader, $timeout, $ionicSlideBoxDelegate, $rootScope, $log ) {

  var postsApi = $rootScope.url + 'schedule/';
